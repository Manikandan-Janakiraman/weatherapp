...
import winds from './assets/img/winds.png';
    ...
    <>
      ...
      <div className='container'>
        ...
        <div className='data-container'>
          ...
          <div className='element'>
            <img src={winds} alt="wind" className='wind-icon' />
            <div className='data'>
...
function App() {
  ...
  const search = async () => {
    ...
    try {
      ...
      setTemp(Math.floor(data.wind.deg));
      setCity(data.name);
  ...
  return (
    <>
      ...
      <p className='copyright'>
        Designed & Developer by <span>Manikandan</span>
      </p>
    </>
  )
}
